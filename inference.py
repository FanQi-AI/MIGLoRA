...
for v in json_data:
    ...
    for iit in range(0, len(r_obj_bbox)): # 改动
    ...
    weights =calculate_weights(r_obj_bbox)
    print(weights,'187')
    ...
    draw_image(cond_image, r_obj_bbox, r_obj_class, "%s/%s.png" % (save_dir_bbox, img_id))
